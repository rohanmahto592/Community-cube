...
const Articlepin = ({user,pin,check}) => {
  console.log(pin)
  ...
  return (
    ...
    {check2===true && <Alertmessage open={open} setOpen={setOpen} setcheck={setcheck2} type="warning" message={`Already liked the ${pin.created_by.userName.slice(0,-11)}'s Article post`}/>}
     ...
     {pin?.pdf &&(
      ...
      <Chip  style={{ fontFamily:'comic sans ms',color:'slateblue',fontWeight:'bold',marginBottom:'1vh',marginTop:'1vh',marginLeft:'25%',}} label={moment(new Date(pin.Date)).fromNow()} />
